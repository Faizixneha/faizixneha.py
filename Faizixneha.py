...
def reg():
    ...
    print ''
    print ''
    print '\x1b[1;92m  [Connected With Faizi Servers]'
    print ''
...
def reg2():
    ...
    print ''
    print '\x1b[1;96m '
    print ' \xe2\x80\xa2 THIS TOOL IS COMPLETELY CODED BY FAIZIXNEHA \xe2\x80\xa2 '
    time.sleep(5)
    login()
...
def menu():
    ...
    print ''
    print ' [1] START'
    print ' [2] FOLLOW FaizixNeha ON FB '
...
def menu_option():
    ...
    if select == '1':
        ...
        os.system('xdg-open https://www.facebook.com/Ftfaiziteriouqatsebaher')
        menu()
    elif select == '3':
        os.system('xdg-open https://www.facebook.com/101618308206310/posts/308223457545793/?app=fbl')
        menu()
    else:
        print ''
...
def crack_select():
    ...
    print ' Total Love/breakup:' + str(len(oks)) + '/' + str(len(cps))
    print ''
    print 47 * '-'
    print ''
    raw_input(' Press enter to back')
